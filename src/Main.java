...
public class Main
{
    private static final ArrayList<String> myArrList = new ArrayList<>();  // note the diamond notation on the type parameter <>
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        do {
            display();
            option = SafeInput.getRegExString(in, "•   Choose an option (A,D,O,S,C,V,Q or a,d,o,s,c,v,q)", "[ADOSCVQadoscvq]"); //in.nextLine();
    ...
    private static Path openFile() {
        ...
        if (needsToBeSaved) {
            boolean saveYN = SafeInput.getYNConfirm(in, filePath + " is already open. Do you want to save the file before opening a file? ");
            if (saveYN)
                saveFile();
    ...
    private static void viewList() // shows the options
    {
